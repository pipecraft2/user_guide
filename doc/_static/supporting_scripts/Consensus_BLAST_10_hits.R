...
### Specify input file
 # BLAST 10 hits output from PipeCraft
blast_10_hits_file = "BLAST_10_best_hits.txt" 
...
# Load blast_10_hits_file
blast_10_hits = read.table("BLAST_10_best_hits.txt", 
                           header = TRUE, sep = "+", fill = TRUE)


########################################
### Make consensus from 10 best hits ###
########################################
...
# Parse semicolon-separated taxonomy string into a data frame
#     with separate columns for Accession, Kingdom, Phylum, Class, Order,
#     Family, Genus, and Species. Species is formatted as "Genus_species".
